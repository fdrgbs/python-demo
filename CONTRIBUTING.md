...
`python-demo` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/python-demo
[issue tracker]: https://github.com/<USERNAME>/python-demo/issues
